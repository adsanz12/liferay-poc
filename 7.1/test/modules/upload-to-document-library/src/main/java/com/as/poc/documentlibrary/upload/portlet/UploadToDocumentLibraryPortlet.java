package com.as.poc.documentlibrary.upload.portlet;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=UploadToDocumentLibrary",
...
public class UploadToDocumentLibraryPortlet extends MVCPortlet {
}